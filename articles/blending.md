...
side by side, works through two composites, covers the ready-made
...
and a village. The orthophoto is fetched at 1 m, so it lies on the
terrain grid.
...
#>   1. file25c452f1ed51.tif         (background) opacity 1.00  range auto
#>   2. file25c42a74204.tif          multiply    opacity 0.50  range 0.7-1
